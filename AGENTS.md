# EventHub - Project Conventions for Codex
...
- Follow guidelines in `.Codex/docs/playwright-best-practices.md`
...
## Skill Documents
- `.Codex/docs/playwright-best-practices.md` — Playwright testing standards
- `.Codex/docs/eventhub-domain.md` — Domain knowledge and business rules
